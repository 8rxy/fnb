...
CREATE TABLE `box_owner` (
  ...
  PRIMARY KEY (`boxid`,`ownerid`),
  KEY `fk_owner_id_idx` (`ownerid`),
  CONSTRAINT `fk_box_id` FOREIGN KEY (`boxid`) REFERENCES `box` (`idbox`),
  CONSTRAINT `fk_owner_id` FOREIGN KEY (`ownerid`) REFERENCES `owner` (`idowner`)
...
INSERT INTO `box_owner` VALUES (1010107,1),(1010108,2),(1010108,3),(1010107,4),(1010108,4);
...
-- Dump completed on 2021-11-20 19:48:59
